...
function preload() {
  table = loadTable('assets/schedule_mtl_2021.csv', 'csv', 'header'); // table structure: https://docs.google.com/spreadsheets/d/1O-Ixi8d5Gf1nmgDBYvxo0RLJXK1R2jfMXBvSlnuaFuU/edit?usp=sharing
...
function draw() {
  ...
  var h = (24 + date.getUTCHours() - 5) % 24;      // Values from 0 - 23, UTC, CHANGE FOR YOUR OWN TIMEZONE!!
